...
const PathOfVisionaries = () => {
    ...
    return (
        <section className="plaque-pick">
            ...
            <p>
                V Berlíně, v části zvané Kreuzberg, se nachází umělecký projekt
                s názvem Pfad der Visionäre, který sestává z desek umístěných na
                povrchu chodníku pěší zóny. Každá deska obsahuje citát významné
                osoby každé členské země EU.
            </p>
