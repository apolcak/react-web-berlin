    ...
    return (
        <div className="container">
            ...
            <section className="hero">
                <p>
                    Tento web je vytvořen pomocí knihovny React a zaměřuje se na
                    prezentaci využití jeho základních hooků a technik.
                    <br />
                    Tématem webu je hlavní město Německa, které jsem měl možnost
                    nedávno navštívit.
                </p>
            </section>
            <PathOfVisionaries />
