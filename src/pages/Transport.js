...
const Transport = () => {
    ...
    return (
        <div className="container">
            ...
            <section>
                <form
                    onSubmit={handleStopSearchSubmit}
                    className="transport-form"
                >
                    <label htmlFor="search-stop">
                        Zadejte název zastávky:&nbsp;
                    </label>
                    ...
                    <p>
                        <i>
                            Např. Brandenburg, Marzahn, Antonplatz, Kaiserdamm,
                            ...
                        </i>
                    </p>
                </form>
                {foundStops.length > 0 && (
                    <div className="stops">
                        <h2 className="stops__title">
                            Prvních 10 výsledků vyhledávání
                        </h2>
